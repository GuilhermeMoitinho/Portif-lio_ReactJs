...
import contactImg from "../assets/img/ImagemAtt.jpg";
import 'animate.css';
    ...
    <section className="contact" id="connect">
      <Container>
        <Row className="align-items-center">
          <Col size={12} md={6}>
            <TrackVisibility>
                <img className="ImageContact"  src={contactImg} alt="Contate-nos" />
            </TrackVisibility>
          </Col>
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <form action="https://formsubmit.co/guilhermemoitinho3165@gmail.com" method="POST">
                    <Row>
