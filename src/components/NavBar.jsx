  ...
  return (
    <Router>
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="/">
           <Nav.Link href="#home"><h1 className="Logo">G <span>M</span></h1></Nav.Link> 
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a className="imgLinkedin" href="https://www.linkedin.com/in/guilherme-moitinho-177034198/" target="_blank"><img src={navIcon1} alt="" /></a>
                <a className="imgGitHub" href="https://github.com/GuilhermeMoitinho" target="_blank"><img src={navIcon2} alt="" /></a>
              </div>
              <HashLink to='#connect'>
